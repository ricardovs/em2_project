...
CMSISDIR=${GECKOSDKDIR}/cmsis
CMSISDEVINCDIR=${GECKOSDKDIR}/Device/SiliconLabs/EFM32GG/Include
...
usage:
	...
	@make "make proxy"       start a gdb proxy
...
#
test:
	echo "Inside VSCODE=${INSIDEVSCODE}"
...
.PHONY: docs docs-clean doxygen dump edit flash gdbproxy gdbproxy
